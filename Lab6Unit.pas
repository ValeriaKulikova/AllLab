...
var wd:HWND;   // for handle
    canvas:TCanvas;
begin
  wd:=FindWindow(nil,'Работа с окнами');//handle
  ...
  ReleaseDC(0,wd);  // освобождает общий или оконный контекст устройства, делая
  // его доступным для других прикладных задач
end;
